...
This index is a navigation aid for humans and agents.

It does not replace the authoritative documents it references.

If this index diverges from an authoritative reconciliation, audit, map, or implementation document, the referenced document wins.

Use this file to find the right document family before reading specific documents.

## Start Here

- `README.md` — repository overview and entry point.
- `architecture.md` — current architectural overview.
- `ontology.md` — current ontology overview.
- `seed.md` — Seed thesis / system framing.
- `architectural_knowledge_map.md` — map of architectural knowledge areas.
...
- `documentation_boundary_enforcement_reconciliation.md`
...
- `working_state_activation_observation.md` — observation of how preserved, visible, navigable, or consumed material becomes live in working state, and why incorrect scoping can still occur after the right document is found and read.
...
## Time, Change, Learning, And Contradiction
...
## Host, Local, And Prometheus Observation
...
## State, Projection, Read Models, And Surfaces
...
## Storage And Filesystem Topology
...
## Capability, Tools, Execution, And Operator Action
...
## Federation, Identity, And Authority
...
## Explainability, Response, And Why-Not
...
## Repository Self-Observation And Self-Model
...
This index is intentionally curated rather than exhaustive.

When adding a new reconciliation or audit, add it to one or more relevant sections.

Prefer topical grouping over chronological grouping.

Do not treat this index as architectural authority.
