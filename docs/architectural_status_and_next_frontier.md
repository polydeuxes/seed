...
- implementation of operation, inquiry, selection/attention, attention trigger/target, object/role/operation, persistence, continuity, current-work-position, active-edge, derivation, attribution, or continuation-lineage runtimes/schemas before those frontiers are reconciled;
