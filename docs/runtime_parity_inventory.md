...
| Runtime trace | Missing | Present | `RuntimeTrace` is explicitly for RuntimeLoop runs and reconstructs `decision.recorded`, policy/tool/assistant events. [`seed_runtime/runtime_trace.py:1-45`](../seed_runtime/runtime_trace.py#L1-L45) [`docs/archive/original_book_of_seed/03-runtime-loop.md:165-180`](archive/original_book_of_seed/03-runtime-loop.md#L165-L180) |
