...
| Preservation Surfaces | **Observation / Not Reconciled / Not Implementation-Ready** | `preservation_surface_observation.md` observes artifact, inquiry, observation, discovery, and continuation preservation surfaces and whether preservation behavior explains recent concepts better than category membership without defining preservation ontology, taxonomy, workflow, governance, schema, runtime behavior, or implementation. |
| Explanatory Load | **Observation / Not Reconciled / Not Implementation-Ready** | `explanatory_load_observation.md` observes candidate explanatory-load cases, bounded responsibility, load shifts, decomposition, pressure survivors, responsibility routing, and unresolved uncertainty without defining explanatory load canonically or proposing ontology, workflow, runtime, schema, governance, memory-system, learning-system, or implementation changes. |
