...
IMPLEMENTATION_SPECS: dict[str, DiagnosticImplementationSpec] = {
    ...
    "external_material_structure": DiagnosticImplementationSpec(
        name="external_material_structure",
        module_path="seed_runtime/external_material_structural_projection.py",
        build_function="project_external_material_structure",
        format_function="format_external_material_structural_projection",
        json_function="external_material_structural_projection_json",
    ...
    "emitter_attribution_audit": DiagnosticImplementationSpec(
        name="emitter_attribution_audit",
        module_path="seed_runtime/emitter_attribution_audit.py",
        build_function="build_emitter_attribution_audit",
        format_function="format_emitter_attribution_audit",
        json_function="emitter_attribution_audit_json",
    ...
    "projected_observation_record_inventory": DiagnosticImplementationSpec(
    ...
    "projected_support_diagnostic": DiagnosticImplementationSpec(
        ...
        module_path="scripts/seed_local.py",
        build_function="fact_support_query",
        format_function="format_fact_supports",
        cli_flags=("--fact-support",),
    ),
    "selection_explanation_diagnostic": DiagnosticImplementationSpec(
        name="selection_explanation_diagnostic",
        module_path="scripts/seed_local.py",
        build_function="fact_query_state",
        format_function="format_explanation",
        cli_flags=("--why",),
    ),
    ...
    "projection_stage_definition": DiagnosticImplementationSpec(
        name="projection_stage_definition",
        module_path="seed_runtime/projection_shape.py",
        build_function="build_projection_stage_definition",
        format_function="format_projection_stage_definition",
    ...
    "constitutional_pipeline_diagnostic": DiagnosticImplementationSpec(
        name="constitutional_pipeline_diagnostic",
        module_path="seed_runtime/constitutional_pipeline_diagnostic.py",
        build_function="build_constitutional_pipeline_diagnostic",
        format_function="format_constitutional_pipeline_diagnostic",
        json_function="constitutional_pipeline_diagnostic_json",
