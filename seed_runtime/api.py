"""Dependency-light API shell around canonical Seed RuntimeLoop services.
...
class SeedAPI:
    ...
    def post_user_message(self, workspace_id: str, session_id: str, text: str) -> RuntimeResult:
