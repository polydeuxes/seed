...
DIAGNOSTIC_INVENTORY: tuple[DiagnosticInventoryEntry, ...] = (
    ...
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Observes front matter, heading outline metadata, and structural Markdown link targets for top-level repository docs without interpreting prose, link text, extracting claims, inferring authority, inferring shapes, writing events, or mutating the repository.",
    ),
    DiagnosticInventoryEntry(
