...
DIAGNOSTIC_INVENTORY: tuple[DiagnosticInventoryEntry, ...] = (
    DiagnosticInventoryEntry(
        ...
        description="Runs one versioned two-treatment operator-ingress bootstrap probe, records occurrence evidence, projects current standing, and stops without cluster mutation.",
    ),
    DiagnosticInventoryEntry(
    ...
    DiagnosticInventoryEntry(
        name="external_material_structure",
        cli_flags=("--external-material-structure",),
        uses_projected_state=False,
        uses_repo_files=True,
        supports_json=True,
        supports_record=False,
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Projects caller-supplied exact text for a selected external artifact into mechanical line records and nonblank regions without interpretation, event-ledger writes, or cluster mutation.",
    ),
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Projects caller-supplied external material structural projection JSON into raw line-length features and nonblank-region length sequences without interpretation, event-ledger writes, or cluster mutation.",
    ),
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Projects caller-supplied bounded inquiry, bounded corpus inventory, and candidate-work visibility testimony into an immutable read-only examination frontier without discovery, selection, execution, event-ledger writes, or cluster mutation.",
    ),
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Validates caller-supplied testimony references against a bounded external-material manifest without interpretation, event-ledger writes, or cluster mutation.",
    ),
    DiagnosticInventoryEntry(
    ...
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Composes existing read-only capability-state owner artifacts for one normalized capability string without selection, verification, authorization, execution, event-ledger writes, or cluster mutation.",
    ),
    DiagnosticInventoryEntry(
    ...
    DiagnosticInventoryEntry(
        name="projected_observation_record_inventory",
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Compatibility diagnostic for projected observation-record inventory; does not establish attributed-testimony standing.",
    ),
    DiagnosticInventoryEntry(
        name="current_selection_diagnostic",
        cli_flags=("--current-selection SUBJECT PREDICATE",),
        uses_projected_state=True,
        uses_repo_files=False,
        supports_json=False,
        supports_record=False,
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Read-only diagnostic for values selected by Seed-internal projection-local current selection; does not establish Fact standing, operator truth, verified current state, permission to act, or present-facing applicability.",
    ),
    DiagnosticInventoryEntry(
        name="projected_support_diagnostic",
        cli_flags=("--fact-support",),
        uses_projected_state=True,
        uses_repo_files=False,
        supports_json=False,
        supports_record=False,
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Diagnostic for aggregate projected support groups; does not establish Fact standing or current applicability.",
    ),
    DiagnosticInventoryEntry(
        name="selection_explanation_diagnostic",
        cli_flags=("--why",),
        uses_projected_state=True,
        uses_repo_files=False,
        supports_json=False,
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Diagnostic explanation of projected support selection; does not establish Fact warrant or current applicability.",
    ),
    DiagnosticInventoryEntry(
    ...
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Shows the read-only Constitutional Process View by composing existing constitutional process evidence without recording, event-ledger writes, cluster mutation, runtime sequencing, process execution, or new constitutional authority.",
    ),
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Shows the read-only Constitutional Governance View by composing existing constitutional governance evidence without recording, event-ledger writes, cluster mutation, governance execution, ownership recovery, hierarchy, runtime governance, or new constitutional authority.",
    ),
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Shows the read-only Constitutional Fidelity View by composing the completed fidelity evidence corpus without recording, event-ledger writes, cluster mutation, recovery, mutation, enforcement, runtime evaluation, redesign, or new constitutional authority.",
    ),
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Invokes the complete read-only constitutional pipeline only from an already-established BoundedConstitutionalQuestion without raw question origination, recording, event-ledger writes, cluster mutation, selection-key inference, capability discovery, persistence, planning, recovery, or new constitutional authority.",
    ),
    DiagnosticInventoryEntry(
        name="constitutional_pipeline_diagnostic",
        cli_flags=("--constitutional-pipeline-diagnostic",),
        uses_projected_state=False,
        uses_repo_files=False,
        supports_json=False,
        supports_record=False,
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Runs the complete read-only constitutional pipeline diagnostic only from an already-established BoundedConstitutionalQuestion and exposes typed stage-level diagnostic evidence without raw question origination, recording, event-ledger writes, cluster mutation, stage algorithm ownership, selection-key inference, capability discovery, persistence, planning, recovery, or new constitutional authority.",
    ),
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Composes explicitly requested registered constitutional views into one read-only bounded explanation without recording, event-ledger writes, cluster mutation, runtime reasoning, evidence discovery, planning, orchestration, the Eye, or new constitutional authority.",
    ),
    DiagnosticInventoryEntry(
