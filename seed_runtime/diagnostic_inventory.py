...
DIAGNOSTIC_INVENTORY: tuple[DiagnosticInventoryEntry, ...] = (
    ...
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Compatibility diagnostic for projected fact-support inventory; does not establish Fact standing or current applicability.",
    ),
    DiagnosticInventoryEntry(
        name="current_selection_diagnostic",
        cli_flags=("--current-facts SUBJECT PREDICATE",),
        uses_projected_state=True,
        uses_repo_files=False,
        supports_json=False,
        supports_record=False,
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Compatibility diagnostic for values selected by projected current-fact getters; does not establish present-facing applicability.",
    ),
    DiagnosticInventoryEntry(
