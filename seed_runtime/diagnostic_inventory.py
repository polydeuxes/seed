...
DIAGNOSTIC_INVENTORY: tuple[DiagnosticInventoryEntry, ...] = (
    ...
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Invokes the complete read-only constitutional pipeline from explicit operator-supplied bounded inputs without recording, event-ledger writes, cluster mutation, selection-key inference, capability discovery, persistence, planning, recovery, or new constitutional authority.",
    ),
    DiagnosticInventoryEntry(
        ...
        mutates_cluster=False,
        reads_diagnostic_facts=False,
        description="Runs the complete read-only constitutional pipeline from explicit bounded inputs and exposes typed stage-level diagnostic evidence without recording, event-ledger writes, cluster mutation, stage algorithm ownership, selection-key inference, capability discovery, persistence, planning, recovery, or new constitutional authority.",
    ),
    DiagnosticInventoryEntry(
