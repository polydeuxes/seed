...
class SQLiteEventLedger(EventLedger):
    ...
    _RESERVABLE_PREFIXES = frozenset({
        ...
        "addressed_material_coordinate_assignment",
        "addressed_material_coordinate_assignment_subject",
        "addressed_material_coordinate_applicability_act",
        "addressed_material_coordinate_applicability_act_occurrence",
        "addressed_material_coordinate_applicability_result",
        "addressed_material_coordinate_measurement_act",
        "addressed_material_coordinate_measurement_act_occurrence",
        "addressed_material_coordinate_measurement_result",
