...
class SQLiteEventLedger(EventLedger):
    ...
    _RESERVABLE_PREFIXES = frozenset({
        ...
        "variable_extent_responsibility",
        "variable_extent_responsibility_subject",
        "recurrent_bounded_literal_measurement_act",
        "recurrent_bounded_literal_measurement_act_occurrence",
        "recurrent_bounded_literal_measurement_result",
