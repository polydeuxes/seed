...
3. **Authority and scope binding after interpretation.** `OperatorAuthorityScopeBindingProjection` binds interpreted requests to operator identity, workspace/session authority, resolved/permitted/excluded/unresolved scopes, authority sources, constraints, state, reason, .
