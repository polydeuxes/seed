...
def test_deleted_static_constitutional_registrations_are_absent():
    from seed_runtime.read_model_ownership import READ_MODEL_VIEW_REGISTRATIONS

    names = {registration.name for registration in READ_MODEL_VIEW_REGISTRATIONS}
    assert names.isdisjoint(
        {"constitutional_process", "constitutional_governance", "constitutional_fidelity"}
    )
