...
def test_exact_set_binding_preserves_presented_choice_set_and_token():
    ...
    assert binding.selected_presented_alternative_ref == "show_inventory"
...
def test_unsupported_unknown_and_conflicting_selection_evidence_is_preserved():
    ...
    assert unsupported.selected_presented_alternative_ref is None
    ...
    assert unknown.selected_presented_alternative_ref is None
    ...
    assert conflict.selected_presented_alternative_ref is None
...
def test_same_token_has_local_meaning_in_different_choice_sets():
    ...
    assert a.selected_presented_alternative_ref == "show_inventory"
    assert b.selected_presented_alternative_ref == "prove_non_transition"
...
def test_binding_stops_before_goal_inquiry_authority_or_execution_transition():
    ...
    assert binding.selected_presented_alternative_ref == "show_shape_audit"
    forbidden = str(data)
