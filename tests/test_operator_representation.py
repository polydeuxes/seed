...
PYTEST_ADMISSION = (
    test_representation_reader_reads_the_exact_recorded_representation,
    test_representation_carries_exact_material_without_claiming_meaning,
    test_representation_refuses_a_changed_exact_material_rule,
    test_empty_exact_material_carries_its_rule_through_emission,
    test_representation_addresses_one_exact_carried_measurement_result,
    test_representation_addresses_each_structured_measurement_family,
    test_representation_rejects_each_wrong_carried_measurement_coordinate,
    test_exact_result_carrier_does_not_stand_for_measurement_result_carrier,
    test_representation_refuses_a_nonexact_measurement_carrier,
    test_representation_refuses_a_measurement_reference_under_the_wrong_key,
    test_representation_refuses_a_subclassed_measurement_reference,
    test_representation_rejects_corrupted_measurement_yield,
    test_unrelated_occurrence_does_not_change_addressed_measurement_result,
    test_representation_reader_rejects_a_substituted_measurement_reference,
    test_emission_attempt_reference_cannot_substitute_for_representation_source,
    test_representation_consumes_an_exact_yielded_representation_result,
    test_representation_refuses_a_raw_carrier_without_exact_yield,
    test_representation_refuses_a_nonidentity_result_carrier,
    test_representation_does_not_accept_developer_supplied_exact_material,
    test_representation_refuses_a_missing_source_occurrence,
    test_representation_refuses_a_source_from_another_locality,
    test_representation_refuses_a_source_after_its_standing_boundary,
    test_representation_refuses_a_standing_boundary_from_another_locality,
    test_representation_refuses_corrupted_source_material,
    test_representation_reader_and_egress_refuse_changed_material,
    test_exact_egress_reads_the_recorded_representation_material,
    test_exact_material_emission_preserves_each_bounded_failure_result,
    test_exact_material_process_death_leaves_only_the_durable_attempt,
    test_exact_material_emission_recovers_recorded_order_and_refuses_wrong_occurrence,
    test_raw_console_does_not_select_operator_input_for_egress,
    test_representation_reader_refuses_each_missing_evidence_pointer,
    test_representation_reader_refuses_a_developer_formed_event,
    test_representation_reader_refuses_a_different_carried_result,
    test_representation_reader_refuses_different_act_evidence_coordinates,
    test_representation_reader_refuses_different_locality_evidence_content,
    test_console_forms_c0_before_first_ingress_and_preserves_provenance_only,
    test_console_material_acquisition_adds_only_its_exact_occurrences,
    test_c0_presents_standing_with_no_developer_semantics,
    test_representation_act_dimensions_record_only_coordinates_that_exist,
    test_console_presents_standing_only_across_an_acquire,
    test_c0_and_c1_are_recorded_in_order_without_authored_output,
    test_representations_from_other_localities_cannot_enter,
    test_representation_representation_is_deterministic_under_unrelated_events,
    test_next_console_iteration_validates_c1_and_forms_c2,
    test_later_operator_material_does_not_replace_an_earlier_focus,
    test_acquisition_act_and_eof_do_not_manufacture_representation_results,
    test_first_interaction_attaches_no_representation_to_the_acquire,
    test_each_material_acquisition_freezes_one_exact_byte_measurement_boundary,
    test_each_material_acquisition_freezes_one_exact_occurrence_position_boundary,
    test_empty_operator_boundary_records_no_measurement,
    test_representation_act_is_recorded_without_manufacturing_emission,
)
