...
def test_candidate_coordinate_order_is_the_exact_book_order():
    clause = _clause("01.Source.E")
    source_book = (
        GRAMMAR.parent / "chapters" / "07_measurement_and_candidates.md"
...
PYTEST_ADMISSION = (
    ...
    test_every_relation_has_exact_fidelity_findings,
    ...
    test_no_new_site_compounds_scope_with_locality,
    test_every_live_relation_witness_names_its_relation_and_its_evidence,
    test_each_relation_has_a_live_witness,
