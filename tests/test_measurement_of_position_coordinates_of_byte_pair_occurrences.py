...
PYTEST_ADMISSION = (
    ...
    test_position_assertion_movement_requires_its_exact_source_after_act_occurrence,
    test_position_assertion_movement_requires_its_exact_source_after_yield_relation,
