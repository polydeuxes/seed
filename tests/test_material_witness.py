...
FIDELITY_SUBJECTS = {
    "exact_act_occurrence": (
        ...
        test_every_measured_pair_reaches_every_compiled_format_implementation_function,
        test_full_function_coordinates_precede_every_added_material_invocation,
        ...
        test_compiled_invocation_validates_each_source_once_before_function_fan_out,
        test_equal_material_at_distinct_coordinates_reaches_the_implementation_function_each_time,
        test_compiled_implementation_function_refusal_and_input_boundary_are_distinct,
        test_a_non_byte_material_is_refused_before_an_implementation_function_occurs,
        test_exact_bytes_reach_the_implementation_function_without_prior_decoding,
    ...
    "measurement_result_distinctions": (
        ...
        test_removal_recurrence_returns_coordinate_before_later_compare,
        test_recurrence_before_later_refuses_wrong_function_identity,
        test_full_function_recurrence_refuses_reordered_source_occurrences,
        test_removal_full_function_recurrence_refuses_reordered_source_occurrences,
        test_recurrence_before_later_requires_a_boolean_control,
        test_full_function_recurrence_preserves_heterogeneous_coordinates,
        ...
        test_position_pair_composition_preserves_supplied_position_order,
        test_position_recurrence_refuses_reordered_or_non_suffix_material,
        test_position_recurrence_keeps_later_match_and_conflict_in_order,
        test_every_ordered_pair_is_compared_for_each_compiled_function,
        test_compiled_functions_establish_different_pairwise_distinctions,
        test_each_addition_compare_keeps_both_invocation_occurrences_and_the_act,
        test_addition_compare_finds_same_and_different_return_coordinates,
        test_every_exact_added_position_pair_has_one_compare_occurrence,
        test_added_position_pairs_find_same_and_different_complete_coordinates,
        test_addition_compare_refuses_a_missing_source_reference,
        test_addition_compare_refuses_a_result_without_its_act_occurrence,
        test_each_measured_pair_position_has_an_exact_removal_occurrence,
        test_each_removal_result_reaches_every_compiled_implementation_function,
        test_each_removal_compare_keeps_both_invocation_occurrences_and_the_act,
        test_removal_compare_finds_same_and_different_return_coordinates,
        test_removal_recurrence_precedes_a_later_invocation,
        test_removal_recurrence_is_recovered_before_later_compare,
        test_removal_recurrence_freezes_known_coordinates_before_one_later_act,
        test_removal_recurrence_accepts_a_matching_full_function_vector,
        test_unknown_removal_function_coordinate_does_not_erase_the_known_coordinate,
        ...
        test_addition_uses_exact_removal_results_as_its_source,
    ...
    "input_act_relation_occurrence": (
        ...
        test_compiled_material_results_enter_one_exact_admission,
        test_bash_admission_additions_reach_one_later_compare,
        test_pair_and_byte_admissions_require_every_compiled_function,
        test_compiled_admission_reads_exact_invocation_rows_once,
        test_compiled_format_implementation_functions_admit_the_same_material_differently,
        test_addition_admission_preserves_every_exact_act_occurrence,
        test_addition_admission_finds_recurring_complete_compare_coordinates,
        test_addition_admission_refuses_incomplete_compare_coverage,
        test_equal_result_material_keeps_distinct_occurrences_in_one_admission,
        test_each_function_and_complete_admission_has_one_exact_occurrence,
        test_addition_admission_refuses_a_result_without_its_compare_occurrences,
        test_every_ordered_admission_result_pair_has_one_exact_compare_occurrence,
        test_every_function_admission_preserves_each_function_admission,
        ...
        test_removal_results_enter_admission_through_every_exact_compare,
        test_removal_result_admission_reaches_later_addition_compare,
    ),
    "one_exact_movement_assertion": (
        test_format_recurrence_precedes_later_moved_material,
        test_full_function_coordinates_precede_every_removed_material_invocation,
    ),
    "locality_relation_coordinates": (
        test_admitted_material_addition_refuses_cross_locality_material,
    ),
}
