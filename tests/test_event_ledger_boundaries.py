...
FIDELITY_SUBJECTS = {
    "event_occurrence": (
        test_event_has_its_exact_occurrence_coordinates_and_no_inherited_base,
    ),
    "event_ledger_boundary": (
        test_one_boundary_constrains_every_ordered_reader,
        test_empty_boundary_excludes_later_occurrences,
        test_one_occurrence_resolves_its_existing_append_boundary,
        test_absent_occurrence_cannot_become_an_append_boundary,
        test_equal_prefixes_share_a_boundary_and_later_divergence_does_not_break_it,
        test_exact_material_participates_in_the_append_boundary,
        test_equal_prefixes_persisted_in_separate_ledgers_share_a_boundary,
        test_batched_and_repeated_appends_yield_the_same_boundary,
        test_a_boundary_from_a_different_prefix_is_refused,
        test_a_durable_boundary_survives_reopen,
        test_an_existing_durable_sequence_is_derived_once_without_changing_rows,
        test_partial_durable_mechanics_are_refused,
        test_reopen_refuses_a_stale_prefix_chain_over_reidentified_material,
        test_boundary_resolution_refuses_an_externally_staled_prefix_chain,
        test_forgetting_prefix_validation_recomputes_the_same_boundary,
        test_a_separate_connection_worker_reads_exactly_one_committed_cut,
        test_a_separate_connection_worker_refuses_an_uncommitted_cut_until_flush,
        test_a_separate_connection_worker_refuses_another_ledgers_cut,
        test_a_writer_without_prefix_maintenance_is_refused,
        test_a_formed_unknown_boundary_is_refused,
        test_a_refused_material_leaves_the_ledger_unchanged,
        test_an_in_memory_identity_read_matches_its_occurrence_read,
        test_a_durable_identity_read_matches_its_occurrence_read,
    ),
    "occurrence_material_identity": (
        test_the_two_ledgers_preserve_the_same_material,
        test_occurrence_material_identity_requires_every_recorded_field,
    ),
    "event_material_validation": (
        test_event_exact_material_requires_raw_bytes,
        test_a_material_carrying_a_non_json_number_is_refused,
        test_a_python_subclass_does_not_survive_the_store_and_is_refused,
    ),
}
