...
def test_bounded_inquiry_frontier_preserves_selected_demand_and_remains_read_only():
    ...
    assert frontier.goal_advancement_demand_selection_id==sel.selection_id and frontier.selected_inquiry_demand_reference_id==ref.reference_id
    assert frontier.goal_advancement_demand_set_id==ref.goal_advancement_demand_set_id and frontier.selected_goal_id==ref.goal_establishment_id and frontier.horizon_id==ref.horizon_id
