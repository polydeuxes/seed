...
KEYS = {
    ...
    "relations": ("A", "08.Support.A states the support relation; other clauses state their exact relations"),
    ...
    "responsibility_subjects": ("B", "serializes 'the bounded subjects are exhaustive'; the name is authored"),
