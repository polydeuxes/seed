...
coordinate with its own exact position before any two are combined.
...
256 specimens per channel, 768 in all; the product space is 256 x 256 x 256,
16,777,216 combinations. Read each coordinate alone is what makes the
product space represented without enumerating every specimen.
