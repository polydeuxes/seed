...
- Toolkit generation initially targets non-mutating integration artifacts: input inspectors when needed, `ObservationSource`, `ObservationNormalizer`, CapabilityCatalog entries, HandoffProvider metadata, and tests. Execution remains external to Seed.
