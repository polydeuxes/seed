...
- Evidence and fact models with extraction and state-projection support, so external observations and provider results can become evidence-backed state instead of hidden memory.
