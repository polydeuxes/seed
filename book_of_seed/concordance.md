...
| dimensional characterization | Grammar and Standing | [Constitutional kinds and artifact standing](01-grammar-and-standing/constitutional-kinds-and-artifact-standing.md) | macro dimensions, eight-dimensional characterization, local coordinates | constitutional subject, standing, locality, responsibility, Unknown |
...
| lens | Grammar and Standing | [Lenses, views, and assertion-preserving Uptake](01-grammar-and-standing/lenses-views-and-assertion-preserving-uptake.md) | view, composition, read model | projection, assertion-preserving Uptake relation |
...
| assertion-preserving Uptake relation | Grammar and Standing | [Lenses, views, and assertion-preserving Uptake](01-grammar-and-standing/lenses-views-and-assertion-preserving-uptake.md) | constitutional road | lens, sequence, movement |
| constitutional uptake | Grammar and Standing | [Lenses, views, and assertion-preserving Uptake](01-grammar-and-standing/lenses-views-and-assertion-preserving-uptake.md) | consumer uptake, transition grammar | assertion-preserving Uptake relation, representation, emission, explanation |
| act | Acts and Constraints | [Acts and act artifacts](02-acts-and-constraints/acts-and-act-artifacts.md) | input act, operation | proposal, act occurrence, result |
...
| temporal standing | Evidence and Knowledge | [Testimony and established fact](05-evidence-and-knowledge/testimony-and-established-fact.md) | temporal applicability, support time, currentness | observed_at, expiry, projection, consumer uptake |
| temporal disclosure | Grammar and Standing | [Lenses, views, and assertion-preserving Uptake](01-grammar-and-standing/lenses-views-and-assertion-preserving-uptake.md) | View temporal contract, compact View | temporal standing, provenance navigation, current standing |
...
| projection | Standing and Projection | [Projection and current standing](06-standing-and-projection/projection-and-current-standing.md) | read model, view, projection cache | replay, source record |
| View emission | Grammar and Standing | [Lenses, views, and assertion-preserving Uptake](01-grammar-and-standing/lenses-views-and-assertion-preserving-uptake.md) | egress view, operator-facing view | warrant, reliance, emission |
| ObservationView | Standing and Projection | [Projection and current standing](06-standing-and-projection/projection-and-current-standing.md) | observation view, attributed testimony view | testimony occurrence, FactView |
| FactView | Standing and Projection | [Projection and current standing](06-standing-and-projection/projection-and-current-standing.md) | fact view | Fact standing, ObservationView, current-facing Fact View |
| current-facing Fact View | Standing and Projection | [Projection and current standing](06-standing-and-projection/projection-and-current-standing.md) | current fact view, present-facing Fact View | current standing, projection, Fact standing |
...
| mechanism-fit finding | Evidence and Knowledge | [Testimony and established fact](05-evidence-and-knowledge/testimony-and-established-fact.md) | bounded comparison standing, historical operational realization warrant wording | capability proposition, reachability, selection, authority |
...
| operational measurement | Evidence and Knowledge | [Testimony and established fact](05-evidence-and-knowledge/testimony-and-established-fact.md) | operation-instance testimony, timing sample, elapsed duration | measurement production, testimony, preservation |
| operational baseline | Evidence and Knowledge | [Testimony and established fact](05-evidence-and-knowledge/testimony-and-established-fact.md) | established ordinary operational behavior | baseline establishment, operational measurement, temporal standing, preservation |
| runtime/resource observation | Evidence and Knowledge | [Testimony and established fact](05-evidence-and-knowledge/testimony-and-established-fact.md) | process memory, thread count, process runtime duration, database size, ledger size | testimony, observation, operational measurement attribution |
...
| baseline transition | Evidence and Knowledge | [Testimony and established fact](05-evidence-and-knowledge/testimony-and-established-fact.md) | established changed ordinary behavior, changed regime | transition establishment, operational baseline, temporal standing, evidence support, preservation |
| rebuildability | Standing and Projection | [Projection and current standing](06-standing-and-projection/projection-and-current-standing.md) | reprojectable cache, reconstructable current condition | projection, retained evidence, preservation |
...
| representation and emission boundaries | Authority, Communication, and Stopping | [Representation, emission, and consumer boundaries](08-authority-communication-and-stopping/representation-emission-and-consumer-boundaries.md) | presentation, communication | authority, responsibility transition, receipt, uptake, reliance, explanation |
...
- **Remembering**: preservation of testimony or standing from which later lawful recovery remains available; not current projection and not learning by retained history alone.
...
- **Adaptive reliance**: later warranted consumption of revised standing; not learning establishment and does not establish a later act occurrence by identity.
