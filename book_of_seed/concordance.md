...
| mechanism-fit finding | Inquiry and Examination | [Examination methods and probes](04-inquiry-and-examination/examination-methods-and-probes.md) | bounded mechanism-fitness support, historical operational realization warrant wording | capability proposition, reachability, selection, authority |
...
| Seed-owned act occurrence | Acts and Constraints | [Acts and act artifacts](02-acts-and-constraints/acts-and-act-artifacts.md) | performance boundary, authorized act occurrence | result, recording, testimony |
| operational measurement | Evidence and Knowledge | [Testimony and established fact](05-evidence-and-knowledge/testimony-and-established-fact.md) | operation-instance testimony, timing sample, elapsed duration | measurement production, testimony, preservation decision |
| operational baseline | Evidence and Knowledge | [Testimony and established fact](05-evidence-and-knowledge/testimony-and-established-fact.md) | established ordinary operational behavior, performance baseline | baseline establishment, operational measurement, temporal standing, preservation |
...
- **Gap**: scoped insufficiency relative to a declared reference condition. Demand != Gap, and Gap != Demand by identity, permission, or authorization.
...
- **“Capability demand”**: noncanonical shorthand for Demand content concerning a required transformation, effect, relation, competency, or outcome. It is not an independent constitutional kind, Capability, mechanism, selected mechanism, authorization, or execution.
