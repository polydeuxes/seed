...
## Bounded resolution
Validation of an Act-shaped result does not establish the Act occurrence. A downstream boundary may adopt, narrow, compare, or preserve attributed material without proving the upstream Act occurred unless its own Assertion requires that proof. An Act occurrence consumes its exact applicable inputs and may establish or preserve an exact result. The occurrence-to-result relation requires Evidence. Public code, direct instantiation, equal shape, and read-only behavior establish neither that occurrence nor its relation to the result.
