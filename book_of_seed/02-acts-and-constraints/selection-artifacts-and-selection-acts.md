...
Candidate-identity resolution is not itself a Selection Act. A resolver may compare attributed attributed material with a bounded candidate set and establish that exactly one candidate identity matches. That occurrence does not establish a Selection occurrence, responsible boundary, Selection basis, addressed Act or result boundary, Applicability, or later movement.
