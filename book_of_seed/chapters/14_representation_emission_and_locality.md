...
For one exact Representation candidate, emission Act, and destination operator Locality, this Book assigns this Seed the bounded Representation emission Responsibility to determine Admission. After Admission and before Participation, that Responsibility determines Act-local Applicability for that exact admitted input-to-emission-Act relation.
