...
A kind label, Representation, characterization category, function name, concordance entry, or recurring report type may preserve a bounded distinction for the subject and exact Act it names. It establishes no Standing or mandatory grammar, makes no similarly named material equivalent, and supplies no Authority for the exact Act without preserved Evidence, provenance, Scope, Unknown, and the applicable occurrence boundary.
...
Where an Assertion and established Standing have the same subject, the Assertion's applicability is considered with respect to that current Standing. Preservation of earlier Assertions with the same subject makes no one of them a separate applicability boundary and requires no comparison of the later Assertion against each of them because each exact identity and reference remains preserved. Applicability establishes that the Assertion may bear on that Standing; it establishes no agreement, relation, truth, corroboration, or revision.

Where an applicable Assertion with a bounded subject participates in a Compare, the Compare result may have its own subject, including the comparison, the coordinate distinction, or the result shape. That result subject cannot replace, supersede, or discharge the subject for which applicability was determined. Where a responsible occurrence establishes movement in Standing for that subject, that movement and no other movement is carried; coordinates without newly established Standing remain as previously established or **Unknown**, and the subject remains the subject it was. A subject that ceases to be carried has not been superseded by the result; it has been abandoned, and nothing further can be established about it. This clause establishes neither what carries current Standing into a Compare nor that a Compare result is itself a finding that may participate in another Act; those crossings remain unestablished here.
...
These families are broad constitutional distinctions, not mandatory fields or one fixed representation required across exact subjects. Dimension != field, value, constitutional kind, fixed subject-family set, or key. Each label names neighboring coordinates and establishes no Assertion that every pair is one indivisible scalar: standing is recurrent and cross-cutting; occurrence and preservation are related but separate; source and provenance are neighboring but not equivalent; and authority and support are neighboring but not equivalent. Approximately eight macro-dimensional families != exactly eight constitutional fields; this grouping is neither mathematically nor constitutionally final.
