...
Each coordinate established by an exact Act occurrence is carried as one finding of that responsible occurrence; the finding, responsible occurrence, Evidence, and result boundary remain distinct.
...
- same result content != same result identity or Yield relation
