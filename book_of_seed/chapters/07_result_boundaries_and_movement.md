...
Operator material or already-established Standing may identify an exact result Assertion under a Scope and exact locality relation. The result Assertion is not a new constitutional subject by identity. That exact result Assertion carries its own source, Evidence, Authority, Scope, locality, limits, conflicts, and Unknown.
...
Where current Standing in one Locality carries an earlier and a later exact byte-position-pair Measurement result, the later result carries each earlier exact source occurrence reference and one added occurrence reference, and that occurrence bears one exact input relation, this Seed bears bounded Responsibility from this Book to determine Applicability and compare complete exact findings. A supplied occurrence preserves provenance to a prior source occurrence. An operator material occurrence preserves its exact acquisition result at prior Standing carrying the earlier Measurement result and source occurrences. The result carries exact assignment, input-Applicability, Participation-relation, Compare-Act-occurrence, Yield-Evidence, result, and result-Standing references.
...
Where current Standing in one Locality carries one exact ordered relation-path Assertion and one exact recorded pair-finding comparison result, this Book assigns this Seed bounded Responsibility to determine Applicability and Compare them. Applicability requires that the exact source occurrence of the path is the exact added occurrence of the recorded comparison and that each pair subject of the path has complete recorded comparison findings. The result carries exact assignment, input-relation, Applicability, Participation-relation, Compare-Act-occurrence, Yield-Evidence, result, and result-Standing references.

The result preserves the exact path Assertion reference, recorded comparison result reference, source occurrence, added occurrence, each ordered path role, each exact pair subject, and each exact reference to complete recorded finding content. The comparison cannot revise same-content, conflicting, earlier-result, later-result, or Unknown finding Standing. One pair subject under both inputs establishes no source relation, recurrence, represented relation, or composite material. An inapplicable input participates in no comparison and yields no comparison result.
