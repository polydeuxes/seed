...
A missing or unmatched support result remains bounded to the exact corpus, query, temporal boundary, Authority, and limits that established it. It may establish that bounded negative finding or Unknown. It establishes no falsehood, global absence, invalidity, or absence of an occurrence.
