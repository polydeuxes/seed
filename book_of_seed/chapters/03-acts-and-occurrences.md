...
**Yield** is only the exact evidenced relation from an Act occurrence to its result. Yield != Act, Act occurrence, result, result Standing, novelty, carriage, or persistence. Act occurrence and result co-presence does not establish Yield.
