...
Where Seed performs a Seed-native declared measurement over exact material already preserved within its workspace, Seed bears the Responsibility for that measurement Act. The exact measured subject, rule, scope, Authority, applicable inputs, limits, and possible finding Standing remain local to the measurement; this assignment does not identify its Producer, make recording the measurement occurrence, or transfer the resulting Assertion's fidelity Responsibility back into the measurement. An external, operational, provider-owned, or otherwise differently bounded measurement retains its independently established Responsibility or unresolved owner.
