...
A Compare consuming an Assertion and current Standing produces a result whose own subject may be the comparison, the coordinate distinction, or the result shape. That result subject does not replace, supersede, or discharge the subject compared. Where a Compare result warrants movement, only the movement warranted is carried; coordinates not warranted remain as previously established or **Unknown**, and the subject remains the subject it was. A subject that ceases to be carried has not been superseded by the result; it has been abandoned, and nothing further can be established about it.
