...
An alternative proposed input does not participate by virtue of availability, similarity, equal proposition text or content, or exclusion of another input. Responsible occurrences must establish its own identity and standing, the warrant of its substantive claim or relation, applicability to the exact act, any consumer-local admission required by that road, authority and scope for participation, and preserved provenance, **Unknowns**, conflicts, loss, and negative authority. No unassigned input-set sufficiency, substitution, readiness, or act-permission standing is created; whether one input may occupy another's exact role remains **Unknown** unless a responsible occurrence separately establishes that relation for the exact act, purpose, and scope.
