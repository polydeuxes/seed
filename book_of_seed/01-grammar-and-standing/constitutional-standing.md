...
A warranted relation may receive an Act-local Applicability determination. Where the exact Act requires Admission, the relation must be admitted before participation. Applicable is not admitted; Admission is not participation; participation does not establish that the input supports the result. Each relation remains local to the exact Responsibility and Act.
