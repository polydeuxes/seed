...
| production occurrence | **positively instantiated but unresolved** | Both separate occurrences are required and named by kind, but neither exact occurrence identity is supplied (`operator-ingress-common-grammar-prerequisite.md:103,145`). |
...
| standing-establishment occurrence | **positively instantiated but unresolved** | Each occurrence is required, but no exact occurrence identity or evidence is supplied (`operator-ingress-common-grammar-prerequisite.md:101-105`). |
...
| warrant-producing occurrence | **positively instantiated but unresolved** | The Book requires a separate responsible occurrence but does not identify the exact occurrence (`operator-ingress-common-grammar-prerequisite.md:103,145`). |
...
separate meaning-relation-warrant responsibility
  --produces W1 for “G expresses M”-->
warranted meaning relation
  --is examined for exact relation-to-BOGE use-->
BOGE-local applicability responsibility
  --establishes applicable relation-to-BOGE standing-->
consumer-local admission responsibility
  --admits the same relation with identity, lineage, and limits-->
