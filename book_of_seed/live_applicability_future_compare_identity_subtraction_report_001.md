# Live Applicability future Compare identity subtraction report 001

## Question

The active same-position Applicability Act used to mint and carry:

```text
addressed Compare Act identity
future Compare Act occurrence identity
future Compare result identity
```

for every exact cross-set member. An `inapplicable` result therefore followed
an Applicability Act carrying identities for a Compare occurrence and result
that could never occur.

The subtraction asked what exact distinction those two future identities
established before a positive Compare Act occurrence.

## Control

The tested history preserves these independently readable states:
...
Compare result coordinates survive.
...
answer its exact question without preassigning identities to later physiology
that may remain absent.
